...
\begin{researchentry}
	{Domain-Adversarial Learning for a Vehicle-Agnostic Driving Signature to Detect Preclinical Alzheimer's Disease} % Project Title
	...
	\item Developing a data pipeline harmonizing sampling rates and engineering cognitively meaningful driving features (ADAS utilization, lane stability, braking patterns) to focus on spatial navigation and decision-making rather than vehicle mechanics.
	\item Designing a DANN architecture with gradient reversal layer to extract vehicle-agnostic cognitive signatures, forcing the model to predict Clinical Dementia Rating (CDR) scores while minimizing vehicle-identifiable information.
\end{researchentry}
...
\begin{experienceentry}
	...
	{St. Louis, Missouri, USA} % Location
	{January 2026 - *Present} % Date Range
	\item Guiding students in implementing data pipelines and real-time processing systems using Python, SQL, Apache Airflow, Spark, Kafka, Flink, and Snowflake.
	\item Conducting 20-25 minute oral midterm exams simulating technical data systems design interviews, assessing mastery of distributed storage, fault tolerance, and scaling.
	\item Mentoring 2-4 student groups through semester-long capstone projects, providing architectural advice on data collection, cleaning, and interpretation from real-world sources.
	\item Reinforcing key concepts including data warehousing, NoSQL databases, denormalization techniques, and data privacy principles such as de-identification.
	\item Managing asynchronous technical support via Ed and holding bi-weekly office hours to assist with debugging and distributed systems configuration.
\end{experienceentry}
...
\begin{experienceentry}
	...
	{Washington University in St. Louis} % Organization
	{St. Louis, Missouri, USA} % Location
	{November 2025 - *Present} % Date Range
	\item Leading data analysis and storytelling initiatives, tracking program attendance and impact through SA Tools, survey design and analysis, and social media analytics to drive evidence-based decision-making.
	\item Administering the TFCSS website, including event updates, submission forms, scheduling integration, content creation for spotlight stories, and conducting regular website audits in partnership with SA Marcomm.
	\item Developing comprehensive process manuals and training materials to establish best practices in data evaluation and storytelling for TFCSS staff.
\end{experienceentry}
...
\begin{leadershipentry}
	{Bauer Leaders Academy (BLA) Student Leadership Advisory Board} % Organization Name
	{Washington University in St. Louis, St. Louis, Missouri, USA} % Location
	\begin{positionentry}
		{Member} % Position Title
		{November 2025 - *Present} % Date Range
		\item Providing direct feedback and guidance to BLA leadership on new and existing programs.
		\item Amplifying student voices to assist in the development of new student leadership initiatives and ensure student perspectives are considered in decision-making processes.
		\item Fostering communication between the student body and BLA leadership to enhance the student experience and promote leadership development.
		\item Offering insights on student concerns and encouraging student engagement with leadership opportunities on campus.
	\end{positionentry}
\end{leadershipentry}
...
\begin{leadershipentry}
	...
	\begin{positionentry}
		{Member} % Position Title
		{August 2025 - *Present} % Date Range
...
\begin{leadershipentry}
	...
	\begin{positionentry}
		...
		{May 2025 - *Present} % Date Range
		\item Managing the Council's unified Microsoft Teams workspace and website, establishing centralized communication hubs and maintaining up-to-date information on events, governance, and resources.
		\item Building and maintaining committee membership rosters using ranked-choice preference allocation to balance workload and ensure efficient cross-committee coordination.
		\item Overseeing information architecture for the Council's documentation repository.
		\item Representing the graduate student body to university leadership and supporting the GPC President in advancing strategic council priorities.
...
\needspace{6\baselineskip} % Optional - adjust based on content length
% \vspace{\entrySpacing} % Optional
\begin{leadershipentry}
