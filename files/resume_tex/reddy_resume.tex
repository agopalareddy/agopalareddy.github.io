...
\begin{samepage} % Keep the summary on one page if possible
  \begin{onecolentry}
    MS Computer Science student at Washington University in St. Louis with research experience in deep learning for healthcare applications, including Alzheimer's Disease prediction using multimodal data and domain adaptation techniques. Demonstrated expertise in Python, TensorFlow/Keras, and end-to-end ML pipelines.
  \end{onecolentry}
\end{samepage}
...
\begin{experienceentry}
  ...
  \item Administering the TFCSS website, including event updates, submission forms, scheduling integration, content creation for spotlight stories, and conducting regular website audits.
...
\begin{leadershipentry}{Graduate and Professional Student Council (GPSC)}{Washington University in St. Louis}
  ...
  \end{positionentry}
  \begin{positionentry}{Constitution Committee Chair}{August 2025 - *Present}
